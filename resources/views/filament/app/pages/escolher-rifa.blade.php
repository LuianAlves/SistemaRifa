<div>
    @php
        $rifas = \App\Models\Rifa::get();
    @endphp

    <link href="{{ asset('app/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('app/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
            ...
            @foreach($rifas as $rifa)
                <div class="carousel-item-b swiper-slide">
                    <div class="card-box-a card-shadow">
                        <div class="img-box-a">
                            <img src="{{asset('storage/'.$rifa->imagem)}}" style="height: 350px;" class="img-a img-fluid">
                        </div>
                        <div class="card-overlay">
                            <div class="card-overlay-a-content">
                                ...
                                <div class="card-body-a">
                                    ...
                                    <a href="{{route('filament.app.resources.escolher-rifas.index')}}"
                                       class="btn btn-b-n my-3">PARTICIPAR</a>
                                </div>
